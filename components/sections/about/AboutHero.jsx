export default function AboutHero() {
  return (
    <section className="bg-primary-container text-white py-20 md:py-[80px] px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="font-serif text-5xl md:text-[48px] leading-tight mb-6 max-w-3xl">
